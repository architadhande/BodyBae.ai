    ...
    <body>
        <div class="container">
            ...
            <div id="welcome" class="welcome">
                ...
                <button class="btn btn-primary" onclick="showChat(); return false;" id="start-journey-btn">Start Your Health Journey</button>
                <button class="btn btn-small" onclick="testFunction(); return false;" id="test-btn">Test</button>
                
                <!-- Backup methods -->
                <div style="margin-top: 1rem;">
                    <p style="font-size: 0.9rem; opacity: 0.8;">
                        Having trouble? 
                        <a href="#" onclick="forceShowChat(); return false;" style="color: var(--cream); text-decoration: underline;">
        ...
        <script>
            ...
            // Force show chat - emergency backup
            function forceShowChat() {
                console.log('Force show chat called');
                document.getElementById('welcome').style.display = 'none';
                document.getElementById('chat').style.display = 'block';
                try {
                    initializeGoals();
                } catch (e) {
                    console.log('Goals init failed:', e);
                }
            ...
            function showChat() {
                ...
                try {
                    ...
                    console.log('Chat screen found:', !!chatScreen);
                    ...
                    if (welcomeScreen && chatScreen) {
                        ...
                        document.getElementById('debug').innerHTML = 'Chat loaded successfully! ✅';
                    } else {
                        console.error('Could not find required elements');
                        document.getElementById('debug').innerHTML = 'Error: Missing elements ❌';
                    }
                } catch (error) {
                    console.error('Error in showChat:', error);
                    document.getElementById('debug').innerHTML = 'Error in showChat: ' + error.message + ' ❌';
                }
            }
