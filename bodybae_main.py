...
try:
    ...
    print(f"⚠️ RAG system not available: {e} - using simple responses")
    RAG_AVAILABLE = False
...
<body>
    ...
    <div id="welcome-screen" class="welcome-screen">
        <div class="welcome-content">
            ...
            <button class="cta-button" id="start-chat-btn" onclick="startChat()">
                Start Chatting
            </button>
            <p style="margin-top: 1rem; font-size: 0.9rem; opacity: 0.8;">
                Having trouble? <a href="#" onclick="startChat(); return false;" style="color: var(--cream); text-decoration: underline;">Click here to start</a>
            </p>
        </div>
    </div>
            ...
            <div class="chat-main">
                ...
                <div class="chat-messages" id="chat-messages">
                    <div class="message bot">
                        Hi there! 👋 I'm BodyBae, your AI health and fitness assistant. 
                        <br><br>
                        <strong>Let's get started!</strong> Please fill out your profile on the right side:
                        <br>• Enter your name, age, and gender
                        <br>• Add your height and weight  
                        <br>• Select your activity level
                        <br>• Click "Calculate BMI & Save Profile"
                        <br><br>
                        Once your profile is set up, I'll be able to give you personalized health advice, workout plans, and nutrition guidance! 💪
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add click listener to start chat button
        ...
        function startChat() {
            ...
            if (welcomeScreen && chatScreen) {
                console.log('Both screens found, switching...');
        ...
        async function calculateBMI() {
            ...
            if (!name || !age || !height || !weight || !selectedGender || !activityLevel) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    addBotMessage(`✅ Profile saved! Your BMI is ${result.bmi_info.bmi} (${result.bmi_info.category}). ${result.bmi_info.advice}`);
                    
                    // Add goal-setting prompt after a short delay
                    setTimeout(() => {
                        addBotMessage(`Now, what's your main health goal? You can ask me about:
...
🏃‍♀️ Creating workout routines

Just tell me what you'd like to focus on, and I'll give you personalized advice!`);
                    }, 2000);
